  ...
  return (
    <div>
      <header style={{ marginBottom: 20 }}>
        ...
        <p style={styles.subtitle}>Crie o ciclo, avalie por competência de 0 a 10, e conclua quando terminar.</p>
      </header>
...
const styles = {
  ...
  competencyGrid: { display: "flex", flexDirection: "column", gap: 8, marginBottom: 12 },
  competencyRow: { display: "flex", justifyContent: "space-between", alignItems: "center" },
  competencyName: { fontSize: 13 },
  scoreSelect: { background: "var(--panel-2)", border: "1px solid var(--line)", borderRadius: "var(--radius)", padding: "5px 10px", color: "var(--text)", fontSize: 13, width: 70 },
