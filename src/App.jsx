...
function PrivateArea() {
  ...
  return <Layout><Routes>{isActive ? <><Route path="/" element={<Navigate to="/dashboard" replace />} /><Route path="/dashboard" element={<DashboardPage />} /><Route path="/colaboradores" element={<ColaboradoresPage />} /><Route path="/colaboradores/:id" element={<FichaColaboradorPage />} /><Route path="/central-avaliacoes" element={<CentralAvaliacoesPage />} /><Route path="/comunicados" element={<ComunicadosPage />} /><Route path="/avaliacoes" element={<AvaliacoesPage />} /><Route path="/avaliacao-experiencia" element={<AvaliacaoExperienciaPage />} /><Route path="/mural" element={<MuralPage />} /><Route path="/clima" element={<ClimaPage />} /><Route path="/denuncias" element={<DenunciasPage />} /><Route path="/sugestoes" element={<SugestoesPage />} /><Route path="/avaliacao-comportamental" element={<AvaliacaoComportamentalPage />} /><Route path="/competencias" element={<CompetenciasPage />} /><Route path="/descricao-cargos" element={<DescricaoCargosPage />} /><Route path="/pdi" element={<PdiPage />} /><Route path="/metas" element={<MetasPage />} /><Route path="/carreira" element={<CarreiraPage />} /><Route path="/sucessao" element={<SucessaoPage />} /><Route path="/treinamentos" element={<TreinamentosPage />} /><Route path="/vagas" element={<VagasPage />} /><Route path="/remuneracao" element={<RemuneracaoPage />} /><Route path="/folha-pagamento" element={<FolhaPagamentoPage />} /><Route path="/ferias" element={<FeriasPage />} /><Route path="/rescisao" element={<RescisaoPage />} /><Route path="/config-inss" element={<ConfigInssPage />} /><Route path="/config-irrf" element={<ConfigIrrfPage />} /><Route path="/assinatura" element={<AssinaturaPage />} /><Route path="*" element={<Navigate to="/dashboard" replace />} /></> : <><Route path="/assinatura" element={<AssinaturaPage />} /><Route path="*" element={<PendingSubscriptionPage />} /></>}</Routes></Layout>;
}
